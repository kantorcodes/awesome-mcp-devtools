...
- [HOL Guard](https://github.com/hashgraph-online/hol-guard) 🐍 - Local-first security toolkit with `plugin-scanner` for static scanning of MCP servers and Agent Skills for prompt injection, credential exposure, unsafe commands, and supply-chain risks.
